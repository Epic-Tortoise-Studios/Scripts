...
public class BoxLandedTall : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PlayerBlock = GameObject.Find("***LEVEL_DEPENDENCIES***/BoxSpawns/TallBox");
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            Landing.Play();
            Instantiate(PlayerBlock, new Vector3(transform.position.x, (transform.position.y - 1f), transform.position.z), Quaternion.identity);
            Falling.Play();
