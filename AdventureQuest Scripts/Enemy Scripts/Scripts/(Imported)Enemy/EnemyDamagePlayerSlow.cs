...
public class EnemyDamagePlayerSlow : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        canTakeDamage = true;
        hit = GetComponent<SphereCollider>();
        hit.enabled = false;
    ...
    void Attacking()
    {
        if (enemyanim.GetCurrentAnimatorStateInfo(0).IsName("Mutant Jump Attack")
